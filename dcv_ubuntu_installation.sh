...
sudo sed -i '/\#target-fps/a web-client-max-head-resolution=3840, 2160' /etc/dcv/dcv.conf
...
Section "Screen"
    ...
    SubSection "Display"
        Viewport 0 0
        Depth 24
        Modes "3840x2160" "2560x1440" "1920x1080" "1600x900" "1440x900" "1366x768" "1280x800" "1024x768"
        virtual 3840 2160
    EndSubSection
...
# Purge libreoffice installation
